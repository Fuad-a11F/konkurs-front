...
export class QuestionPageComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private http: HttpClient, public userService: UserService) { }
  ...
  checkResult(form: any) {
    this.result = true
    this.userService.updateVictory(this.subject, form).subscribe((data: any) => {
